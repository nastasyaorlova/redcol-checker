...
st.write("Введите данные о членах редакционных коллегий двух журналов (доля совпадений будет расчитана по первому введеному журналу).
 Вы можете вручную исключить ошибки в совпадениях, чтобы скорректировать расчёт.")
